...
.testimonial-image img {
    max-width: 100px; 
                      ...
                      <body>
                        ...
                        <div class="login-wrapper d-flex align-items-center justify-content-center" id="login-wrapper">
                            <div class="custom-container">
                                ...
                                <div class="testimonial-section d-flex align-items-center my-5">
                                    <div class="testimonial-image">
                                        <img src="https://via.placeholder.com/150" alt="Depoimento" class="img-fluid rounded-circle">
                                    </div>
                                    <div class="testimonial-content ms-4">
                                        <h5 class="text-white">Nome do Cliente</h5>
                                        <p class="text-light">
                                            "Este é um depoimento incrível sobre a experiência que tive. Eu realmente gostei dos serviços e recomendo a todos!"
                                        </p>
                                    </div>
                                </div>
                ...
                const assertividadeValue = (Math.random() * 10 + 90).toFixed(2);
                            ...
                            assertividadeElement.style.marginTop = '4px'; 
